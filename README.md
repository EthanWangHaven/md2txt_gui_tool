...
- **粘贴字体设置**：菜单「设置 → 粘贴字体…」可配置粘贴产物的中文字体、字号、是否加粗，默认**等线 / 12 磅（小四）/ 不加粗**（公式除外全局生效）；各级标题默认**等线 / 14 磅**，字体与字号可在设置中单独配置
- **复刻 Markdown 排版**：设置里的开关（**默认关闭**）——勾选后不再设置字体/字号/加粗，标题与表头保持加粗、保留 Word 默认分级字号，粘贴后使用目标软件的默认字体
...
- 窗口大小位置
- 「Word 常驻加速」开关状态
- 粘贴字体设置（字体、字号、标题字体、标题字号、加粗、复刻 Markdown 排版开关）
